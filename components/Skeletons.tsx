export function PosterSkeleton() {
  return (
    <div className="animate-pulse">
      <div className="aspect-[2/3] rounded-xl bg-[#1a1a2e] border border-[#2d2d4a]" />
      <div className="mt-2 h-3 bg-[#1a1a2e] rounded w-3/4" />
      <div className="mt-1 h-2 bg-[#1a1a2e] rounded w-1/2" />
    </div>
  );
}
...
export function DetailSkeleton() {
  return (
    <div className="animate-pulse max-w-4xl mx-auto px-4 pt-20 pb-32">
      {/* Backdrop */}
      <div className="h-48 md:h-64 rounded-xl bg-[#1a1a2e] mb-6" />
      {/* Title + meta */}
      <div className="flex gap-4">
        <div className="w-24 h-36 rounded-xl bg-[#1a1a2e] flex-shrink-0" />
        <div className="flex-1 space-y-2">
          <div className="h-6 bg-[#1a1a2e] rounded w-2/3" />
          <div className="h-4 bg-[#1a1a2e] rounded w-1/2" />
          <div className="h-3 bg-[#1a1a2e] rounded w-1/3" />
          <div className="flex gap-2 mt-3">
            <div className="h-8 w-24 bg-[#1a1a2e] rounded-lg" />
            <div className="h-8 w-24 bg-[#1a1a2e] rounded-lg" />
            <div className="h-8 w-24 bg-[#1a1a2e] rounded-lg" />
          </div>
        </div>
      ...
      <div className="mt-6 space-y-2">
        ...
        <div className="h-3 bg-[#1a1a2e] rounded w-5/6" />
        <div className="h-3 bg-[#1a1a2e] rounded w-4/6" />
      </div>
    </div>
  );
}
  ...
  return (
    <div className="animate-pulse max-w-lg mx-auto px-4 pt-10 pb-32">
      <div className="flex items-center gap-4 mb-6">
        <div className="w-16 h-16 rounded-full bg-[#1a1a2e]" />
      ...
      <div className="space-y-3 mt-6">
        {Array.from({ length: 4 }).map((_, i) => (
          <div key={i} className="flex gap-3 bg-[#1a1a2e] rounded-xl p-3">
  ...
  return (
    <div className="animate-pulse space-y-3">
      {Array.from({ length: rows }).map((_, i) => (
        <div key={i} className="flex gap-3 bg-[#1a1a2e] border border-[#2d2d4a] rounded-xl p-3">
...
export function SearchSkeleton() {
  return (
    <div className="animate-pulse max-w-lg mx-auto px-4 pt-20 pb-32">
      <div className="h-10 bg-[#1a1a2e] rounded-xl mb-6" />
