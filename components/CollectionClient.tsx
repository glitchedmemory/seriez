  ...
  return (
    <div className="max-w-2xl mx-auto min-h-screen px-4 py-6 pb-24">
      ...
      <div className="relative">
        ...
        <button onClick={handleLike} className={`absolute top-4 right-16 inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-semibold transition-all ${liked ? "bg-[#f87171]/20 text-[#f87171] shadow-[0_0_8px_rgba(248,113,113,0.25)]" : "bg-white/5 text-[#9ca3af] hover:bg-white/10 hover:text-[#f87171] active:scale-95"}`}>
