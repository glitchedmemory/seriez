...
export type SearchLogWhereInput = {
  ...
  id?: Prisma.BigIntFilter<"SearchLog"> | bigint | number
...
export type SearchLogScalarWhereWithAggregatesInput = {
  ...
  id?: Prisma.BigIntWithAggregatesFilter<"SearchLog"> | bigint | number
...
export type SearchLogOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "query" | "createdAt", ExtArgs["result"]["searchLog"]>
...
export interface SearchLogFieldRefs {
  readonly id: Prisma.FieldRef<"SearchLog", 'BigInt'>
